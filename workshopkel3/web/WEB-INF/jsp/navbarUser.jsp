            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        <li><a href="${pageContext.request.contextPath}/product/allproductfashion">Fashion</a></li>
                        <li><a href="${pageContext.request.contextPath}/product/allproductelektronik">Elektronik</a></li>
                        <li><a href="${pageContext.request.contextPath}/product/allproductpb">Perlengkapan Bayi</a></li>
                    </ul>
                    <form class="navbar-form navbar-left" action="/action_page.php" style="margin-left:100px">
